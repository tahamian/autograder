...
blacklist = [
    'os', 'sys', 'subprocess', 'threading', 'cmd', 'shlex', 'trace', 'tracemalloc', 'gc', 'pipes', 'syslog', 'termios',
    'posix', 'multiprocessing', 'concurrent', '_dummy_thread', 'dummy_threading'
]
...
class Function:
    ...
    def __init__(self, function):
        ...
        self.testcase_name = function.get('testcase_name', '')
